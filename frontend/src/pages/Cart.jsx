                        ...
                        <div className="flex flex-col w-[80%]">
                            ...
                            {cartItems.map((item) => (
                                <div key={item._id} className="flex items-center mb-[1rem] pb-2">
                                    ...
                                    <div className="flex-1 ml-4">
                                        <Link to={`/product/${item._id}`} className="text-[#93485b]">
                                            {item.name}
                                        </Link>
                                    ...
                                    <div className="w-24">
                                        <select
                                            className="w-full p-1 bg-black bg-opacity-35 border rounded text-white"
                                            value={item.qty}
                                            onChange={(e) =>
                            ...
                            <div className="mt-8 w-[40rem]">
                                <div className="p-4 rounded-lg">
                                    ...
                                    <button
                                        className="bg-[#93485b] mt-4 py-2 px-4 rounded-full text-lg text-white w-full"
