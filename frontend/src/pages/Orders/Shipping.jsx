            ...
            <div className="mt-[10rem] flex justify-around items-center flex-wrap">
                <form onSubmit={submitHandler} className="w-[40rem]">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            type="text"
                            className="w-full bg-black bg-opacity-35 p-2 border-2 border-black rounded"
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mt-2">
                            <label className="inline-flex items-center">
                                <input
                                    type="radio"
                                    className="form-radio text-[#93485b]"
                                    name="paymentMethod"
                                    value="CashOnDelivery" // Updated payment method
                    ...
                    <button
                        className="bg-[#93485b] text-white py-2 px-4 rounded-full text-white text-lg w-full"
                        type="submit"
                    >
                        Continue
                    </button>
